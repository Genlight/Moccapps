...
public class ProjectVersionsDAOTest extends AbstractDAOTest {
    ...
    public void createProjectVersionWithValidData() throws DAOException {
        ...
        ProjectVersion createdProject= projectVersionDAO.create(project,testData.projectVersion2.getVersion_name());
        ProjectVersion projectVersion1 = new ProjectVersion();
        projectVersion1.setId(2);
        projectVersion1.setProject_id(project.getId());
        projectVersion1.setVersion_name(testData.projectVersion2.getVersion_name());
    ...
    public void findProjectVersionByTagWithValidData() throws DAOException{
        Assert.assertEquals("The returned Project equals the one provided by the id", testData.createdProjectVersion1, projectVersionDAO.findByVersionTag(testData.createdProjectVersion1.getVersion_name()));
    }

    @Test
    public void findProjectVersionByProjectIdWithValidData() throws DAOException{
        Assert.assertEquals("The returned Project equals the one provided by the id", testData.createdProjectVersion1, projectVersionDAO.findByProjectId(testData.createdProjectVersion1.getProject_id()));
    }
