...
public class TestData {
    ...
    public void init(){
        ...
        createdPage2=new Page(2,PAGE_2_NAME,PAGE_2_ORDER,PAGE_2_PROJECT_ID,PAGE_2_PAGE_DATA);
        page3=new Page(PAGE_3_NAME,PAGE_3_ORDER,PAGE_3_PROJECT_ID,PAGE_3_PAGE_DATA);
